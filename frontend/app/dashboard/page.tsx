...
function refreshCss() {
  return `
    ...
    .rank-bar-bg {
      background: linear-gradient(90deg, rgba(0,242,254,0.05), rgba(155,180,202,0.02));
      border-radius: 8px;
      overflow: hidden;
      transition: all 0.3s ease;
    }
    .rank-bar-bg:hover {
      background: linear-gradient(90deg, rgba(0,242,254,0.12), rgba(155,180,202,0.05));
    ...
    <main className="page-shell">
        ...
        <div style={{display:"flex",gap:8,flexWrap:"wrap",alignItems:"center"}}>
          <div style={{display:"flex",alignItems:"center",gap:6}}>
            ...
            <input type="date" value={filterDesde} onChange={e => setFilterDesde(e.target.value)}
              style={{padding:"6px 10px",borderRadius:8,border:"1px solid rgba(0,242,254,0.2)",background:"#0a1526",color:"white",fontSize:12}} />
          </div>
          <div style={{display:"flex",alignItems:"center",gap:6}}>
          ...
          <button onClick={handleFilterApply}
            style={{padding:"6px 14px",borderRadius:8,border:"1px solid rgba(0,242,254,0.3)",background:"rgba(0,242,254,0.15)",color:"#00f2fe",fontSize:12,cursor:"pointer"}}>
            Filtrar
          </button>
          <a href={exportUrl} target="_blank" rel="noreferrer"
            style={{padding:"6px 14px",borderRadius:8,border:"1px solid rgba(179,136,255,0.3)",background:"rgba(179,136,255,0.1)",color:"#b388ff",fontSize:12,textDecoration:"none",marginLeft:"auto"}}>
            📥 Exportar Excel
          </a>
        </div>
      </section>
      ...
      <section className="glass" style={{padding:"6px 12px",marginBottom:16,overflowX:"auto"}}>
        <div style={{display:"flex",gap:6,flexWrap:"nowrap",whiteSpace:"nowrap",padding:"6px 0"}}>
          <Link href="/kiosko" style={{padding:"8px 12px",borderRadius:8,background:"#0a1526",border:"1px solid rgba(0,242,254,0.2)",color:"white",textDecoration:"none",fontSize:11}}>📷 Kiosko</Link>
          <Link href="/reportes" style={{padding:"8px 12px",borderRadius:8,background:"#0a1526",border:"1px solid rgba(0,242,254,0.2)",color:"white",textDecoration:"none",fontSize:11}}>📊 Reportes</Link>
          <Link href="/reportes-auto" style={{padding:"8px 12px",borderRadius:8,background:"#0a1526",border:"1px solid rgba(0,242,254,0.2)",color:"white",textDecoration:"none",fontSize:11}}>📧 Auto-reporte</Link>
          <Link href="/admin/empleados" style={{padding:"8px 12px",borderRadius:8,background:"#0a1526",border:"1px solid rgba(0,242,254,0.2)",color:"white",textDecoration:"none",fontSize:11}}>👥 Empleados</Link>
          <Link href="/admin/qrs" style={{padding:"8px 12px",borderRadius:8,background:"#0a1526",border:"1px solid rgba(0,242,254,0.2)",color:"white",textDecoration:"none",fontSize:11}}>📱 QR</Link>
          <Link href="/yts" style={{padding:"8px 12px",borderRadius:8,background:"#0a1526",border:"1px solid rgba(0,242,254,0.2)",color:"white",textDecoration:"none",fontSize:11}}>YTS</Link>
          <Link href="/empleado" style={{padding:"8px 12px",borderRadius:8,background:"#0a1526",border:"1px solid rgba(0,242,254,0.2)",color:"white",textDecoration:"none",fontSize:11}}>Credencial</Link>
          <Link href="/incidencias" style={{padding:"8px 12px",borderRadius:8,background:"#0a1526",border:"1px solid rgba(0,242,254,0.2)",color:"white",textDecoration:"none",fontSize:11}}>⚠️ Incidencias</Link>
          <Link href="/permisos" style={{padding:"8px 12px",borderRadius:8,background:"#0a1526",border:"1px solid rgba(0,242,254,0.2)",color:"white",textDecoration:"none",fontSize:11}}>🏖️ Permisos</Link>
          <Link href="/calendario" style={{padding:"8px 12px",borderRadius:8,background:"#0a1526",border:"1px solid rgba(0,242,254,0.2)",color:"white",textDecoration:"none",fontSize:11}}>📅 Calendario</Link>
          <Link href="/historial" style={{padding:"8px 12px",borderRadius:8,background:"#0a1526",border:"1px solid rgba(0,242,254,0.2)",color:"white",textDecoration:"none",fontSize:11}}>📋 Historial</Link>
          <Link href="/admin/registros" style={{padding:"8px 12px",borderRadius:8,background:"#0a1526",border:"1px solid rgba(0,242,254,0.2)",color:"white",textDecoration:"none",fontSize:11}}>✏️ Registros</Link>
          <Link href="/admin/login-logs" style={{padding:"8px 12px",borderRadius:8,background:"#0a1526",border:"1px solid rgba(0,242,254,0.2)",color:"white",textDecoration:"none",fontSize:11}}>🔐 Accesos</Link>
          <Link href="/admin/nomina" style={{padding:"8px 12px",borderRadius:8,background:"#0a1526",border:"1px solid rgba(0,242,254,0.2)",color:"white",textDecoration:"none",fontSize:11}}>💰 Nómina</Link>
        </div>
      </section>
      ...
      {loading.cards ? (
        ...
        <section style={{display:"grid",gridTemplateColumns:"repeat(auto-fit, minmax(120px, 1fr))",gap:12,marginBottom:20}}>
          {[
            { label: "Total", value: totalHoy, color: "#00f2fe" },
      ...
      {loading.ranking ? (
        ...
        <section className="glass" style={{padding:20,marginBottom:20,position:"relative",overflow:"hidden"}}>
          ...
          <div style={{display:"flex",flexDirection:"column",gap:8}}>
            {topRank.map((item, i) => {
              const colors = ["#ffd700", "#c0c0c0", "#cd7f32", "#00f2fe", "#b388ff"];
              const color = colors[i] || "#00f2fe";
              return (
          ...
          <div className="glass" style={{padding:20}}>
            ...
            <ResponsiveContainer width="100%" height={180}>
              <BarChart data={barData}>
                ...
                <Bar dataKey="Entradas" fill="#00f2fe" radius={[4,4,0,0]} />
            ...
            <div className="glass" style={{padding:20}}>
              ...
              <ResponsiveContainer width="100%" height={180}>
                <LineChart data={tendencias}>
                  ...
                  <YAxis tick={{fill:"#9bb4ca",fontSize:10}} axisLine={false} tickLine={false} />
                  <Tooltip contentStyle={{background:"#0a1526",border:"1px solid rgba(0,242,254,0.2)",borderRadius:8,color:"white"}} />
                  <Line type="monotone" dataKey="a_tiempo" stroke="#b388ff" strokeWidth={2} dot={{fill:"#b388ff",r:3}} name="A Tiempo" />
            ...
            {sucursalesAnalytics.map((b: any) => {
              ...
              return (
                <div key={b.sucursal_id} className="sparkline-card" style={{
                  ...
                  background:"linear-gradient(135deg, rgba(0,242,254,0.08), rgba(179,136,255,0.04))",
                  border:"1px solid rgba(0,242,254,0.2)",position:"relative",overflow:"hidden"
                }}>
                  <div style={{display:"flex",justifyContent:"space-between",alignItems:"flex-start"}}>
                    <div>
                      <p style={{margin:0,color:"#00f2fe",fontWeight:"bold",fontSize:14}}>{b.nombre}</p>
                      <p style={{color:"#9bb4ca",marginTop:2,fontSize:11}}>{b.total_registros} registros (7d)</p>
                    </div>
                    <div style={{width:40,height:40,borderRadius:"50%",background:b.total_registros>0?"linear-gradient(135deg, #00f2fe, #b388ff)":"rgba(0,242,254,0.1)",display:"flex",alignItems:"center",justifyContent:"center",boxShadow:b.total_registros>0?"0 0 12px rgba(0,242,254,0.5)":"none"}}>
                      <span style={{color:b.total_registros>0?"#0a1526":"#00f2fe",fontSize:14,fontWeight:"bold"}}>{b.total_registros}</span>
                    </div>
                  </div>
                  <div style={{display:"flex",gap:10,marginTop:12,marginBottom:10}}>
                    <div style={{flex:1,textAlign:"center",padding:8,borderRadius:8,background:"rgba(0,0,0,0.3)"}}>
                      ...
                      <p style={{color:"#b388ff",margin:"2px 0 0",fontSize:14,fontWeight:"bold"}}>{b.entradas}</p>
                    </div>
                    <div style={{flex:1,textAlign:"center",padding:8,borderRadius:8,background:"rgba(0,0,0,0.3)"}}>
                    ...
                    <div style={{height:36}}>
                      <ResponsiveContainer width="100%" height={36}>
                        <AreaChart data={trendData}>
                          <Area type="monotone" dataKey="registros" stroke="#00f2fe" fill="rgba(0,242,254,0.12)" strokeWidth={1.5} dot={false} />
                        </AreaChart>
                      </ResponsiveContainer>
                    </div>
                  )}
      ...
      const check = () => {
        ...
        branches.forEach(branch => {
          ...
          const icon = L.divIcon({
            ...
            html: `<div style="width:36px;height:36px;background:${hasRetardo?"linear-gradient(135deg,#ff8c9e,#d04aff)":"linear-gradient(135deg,#00f2fe,#b388ff)"};border-radius:50%;display:flex;align-items:center;justify-content:center;box-shadow:0 0 16px ${hasRetardo?"rgba(255,140,158,0.6)":"rgba(0,242,254,0.6)"};font-size:13px;font-weight:bold;color:#0a1526;border:2px solid ${hasRetardo?"#ff8c9e":"#00f2fe"}">${br.length}</div>`,
    ...
    <section className="glass" style={{padding:20,marginBottom:24}}>
      ...
      <div style={{display:"flex",gap:12,marginBottom:12}}>
        <div style={{display:"flex",alignItems:"center",gap:5}}>
          <div style={{width:14,height:14,borderRadius:"50%",background:"linear-gradient(135deg, #00f2fe, #b388ff)"}} />
      ...
      <div style={{position:"relative"}}>
        <div ref={mapRef} style={{height:400,borderRadius:14,overflow:"hidden",border:"1px solid rgba(0,242,254,0.2)"}} />
